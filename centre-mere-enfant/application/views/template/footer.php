    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
            Maisons des enfants <strong>CENTRE MERE ENFANT</strong>. &copy; Copyrights 2022
        </p>
  ...
  <script src="<?php echo base_url('assets/javascript/formStep.js'); ?>"></script>
  ...
  <!-- <script src="<?php // echo base_url('assets/lib/morris-conf.js'); ?>"></script> -->
